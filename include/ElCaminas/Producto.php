...
class Producto
{
    ...
    public function getThumbnailHtml(){
      ...
      $str = "<div class='col-sm-4 col-lg-4 col-md-4'>";
        $str .= "<div class='thumbnail' style='position:relative'>";
          ...
          $str .= "<div class='caption'>";
            $str .= "<h4><a href='" .  $this->url . "'>". $this->nombre ."<a class='open-modal' href='" . $this->url ."&redirect=".urlencode($_SERVER['REQUEST_URI']). "'><span class='fa fa-external-link'></span></a></h4>";
            $str .= "<p>". $this->descripcion . "</p>";
          $str .= "</div>";
    ...
    return json_encode(array("HOME"=> "/portada/", "id" => $this->id, "nombre" => $this->nombre, "foto" => $this->foto, "descripcion" =>  $this->descripcion, "precio" => $this->getHtmlPrecio()));
  }
