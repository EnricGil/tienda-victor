        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                  ...
                  <li>
                      <a href="producto.php?id=1">Productos</a>
                  </li>
                  <li>
                      <a href="categoria.php?id=3">Categorias</a>
                  </li>
                  <li>
                      <a href="carro.php?&redirect=<?php echo urlencode($_SERVER["REQUEST_URI"]);?>"><i class="fa fa-lg fa-shopping-cart "> </i> </a>
                  </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
